<x-layout>
    ...
    <div class="space-y-4">
        ...
        @foreach($jobs as $job)
            <a class="" href="{{ route('jobs.show', ['id' => $job->id]) }}">
                <div class="flex justify-between items-center group border border-gray-200 px-4 py-6 rounded-lg hover:bg-gray-200">
                    ...
                    <div class="flex justify-end">
                        <a href="{{ route('jobs.edit', ['id' => $job->id]) }}" class="flex justify-between space-x-2 items-center px-4 py-2 group-hover:bg-gray-300 rounded-full">
