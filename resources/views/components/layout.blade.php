        ...
        <nav class="bg-gray-800">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8" src="https://assets.laracasts.com/images/symbol-white.svg" alt="Your Company">
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-laracast href="/about" @class([
                                    'bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium' => request()->routeIs('about'),
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    <x-nav-laracast href="/" @class([
                        'bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium' => request()->routeIs('home'),
                        'text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium' => !request()->routeIs('home'),
                    ]) aria-current="page">Home</x-nav-laracast>

                    <x-nav-laracast href="/about" @class([
                        'bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium' => request()->routeIs('about'),
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="{{ \Illuminate\Support\Facades\Auth::user()->profile_photo_path }}" alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">{{ \Illuminate\Support\Facades\Auth::user()->name }}</div>
                            <div class="text-sm font-medium leading-none text-gray-400">{{ \Illuminate\Support\Facades\Auth::user()->email }}</div>
                        </div>
